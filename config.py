...
FORCE_SUB_1 = int(os.environ.get("FORCE_SUB_1", "-1001863988004"))
FORCE_SUB_2 = int(os.environ.get("FORCE_SUB_2", "-1001973484372"))
FORCE_SUB_3 = int(os.environ.get("FORCE_SUB_3", "-1001953281034"))
